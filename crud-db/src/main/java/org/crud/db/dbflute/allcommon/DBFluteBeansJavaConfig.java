 ...
 */
@Configuration
@ComponentScan(value="org.crud.db.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new org.crud.db.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new org.crud.db.dbflute.allcommon.ImplementedInvokerAssistant();
    }
